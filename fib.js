...
var generate = function () 
{
    ...
    {
        alert("This is number is either greater than 100, less than 2, or not a number");
        $("total_fib").value = "";
    }
    else
    {
        ...
        var stringOutput = "0 ";//initialize the Fibonacci series output to include the first two numbers
        for(count = 0; count<intCount;count++)
        {
            k = i+j
